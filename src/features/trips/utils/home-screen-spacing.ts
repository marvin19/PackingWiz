...
/** Space between major Home sections (Upcoming, Previous, etc.). */
export const HOME_SECTION_SPACING = spacing.xl;
...
export const HOME_VIEW_ALL_LINK_SPACING = spacing.sm;

/** Top padding for scroll content below the header. */
export const HOME_SCROLL_TOP_PADDING = spacing.sm;
